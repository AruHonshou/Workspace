...
| Proveedor | Uso | Credencial | Datos compartidos |
| --- | --- | --- | --- |
| TheirStack | Descubrimiento y paginación de vacantes de portales | Clave del usuario | Puesto, país, periodo y dominios seleccionados |
| Brete / ANE Costa Rica | Resultados del servicio público costarricense | Ninguna | Término y parámetros de la página pública |
